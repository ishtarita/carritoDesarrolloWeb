    ...
    <div class="container">
        ...
        <div class="contenido">
            <font face="Times New Roman" size="6">
                <h1><center>Postres y bebidas</h1>
            </font>
            <div class="contenedor">
                ...
                <?php
                    ...
                    $sql = "select * from inventario where tipo='postres'";
